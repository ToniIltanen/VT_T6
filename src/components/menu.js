  ...
  render() {
    return (
        <nav className="navbar sticky-top navbar-expand-md bg-dark navbar-dark opacity">
            <a className="navbar-brand" href="#" onClick={() => this.goToLink(process.env.PUBLIC_URL + "/verkkokauppa")}>TKI Webstore</a>
            ...
            <ul className="navbar-nav">
                <li className="nav-item">
                    <a className="nav-link" onClick={() => this.goToLink(process.env.PUBLIC_URL + "/verkkokauppa")}>Etusivu</a>
                </li>
                <li className="nav-item dropdown">
                    <a className="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Naiset</a>
                    <div className="dropdown-menu">
                        <a className="dropdown-item" onClick={() => this.goToLink(process.env.PUBLIC_URL + "/verkkokauppa/017c32be-0836-422f-a69b-5e9a170f30fe")}>Housut</a>
                ...
                <li className="nav-item dropdown">
                    <a className="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Miehet</a>
                    <div className="dropdown-menu">
